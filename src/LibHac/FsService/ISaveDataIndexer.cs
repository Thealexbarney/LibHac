...
namespace LibHac.FsService
{
    ...
    /// </summary>
    /// <remarks>Each <see cref="SaveDataIndexerValue"/> value contains information about the save data
    /// including its size and current state, as well as its <see cref="SaveDataSpaceId"/> and save data
    /// ID which represent the save data's storage location on disk.</remarks>
